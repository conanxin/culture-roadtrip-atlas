...
const TRIPS_DATA = [
  ...
  },
  {
    ...
    name: '山西古建自驾线',
    shortName: '山西古建',
    oneLine: '从大同到晋东南，沿途寻找中国古建筑的半部历史——唐、五代、宋、辽、金、元、明、清的木构遗产',
    status: '规划中',
    days: '11天10晚 / 8天压缩 / 14天慢行',
    route: '北京 → 大同 → 应县 → 五台山周边 → 太原 → 平遥 / 介休 → 临汾 / 隰县 → 长治 → 晋城 → 北京',
    themes: ['唐宋木构', '辽金建筑', '彩塑壁画', '寺观祠庙', '晋东南古建'],
    tags: ['古建', '自驾', '山西', '唐宋', '辽金', '壁画彩塑', '文化导览草稿中'],
