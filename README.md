...
v1.0.0 · Stable Release（2026-07-04）保留。

v1.1 在 v1.0 基础上：
- 山西页升级：12 个 A 级核心点位、5 个 B 级强烈推荐点位、2 个 C 级可选
- 5 段路线研究框架（每段主题明确）
- 6 类资料来源索引
- 10 个山西古建关键词（木构 / 斗栱 / 梁架 / 彩塑 / 壁画 / 密檐塔 / 辽金寺院 / 晋东南古建 / 地方信仰 / 佛教空间）
- 8 天压缩版 / 11-12 天深度版两个初步行程方案
- 首页状态从「规划中」更新为「研究建档中」
...
| 路线 | 状态 | 进度 | 链接 |
|------|------|------|------|
| 山西古建自驾线 | 研究建档中（v1.1） | 30% | [查看规划](https://conanxin.github.io/culture-roadtrip-atlas/trips/shanxi-ancient-architecture-roadtrip/) |
