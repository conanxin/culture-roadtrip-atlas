...
山西古建自驾线进入"实用信息核验"阶段：17 个 A/B 级点位的实用信息卡（开放时间 / 闭馆日 / 门票 / 预约 / 停车 / 拍照限制 / 建议停留 / 地图搜索）、高风险点位提示、出发前必须核验面板、每日核对事项。

v1.2.0（路线校准）+ v1.1.0（研究建档）+ v1.0.0（稳定发布）保留。

v1.3 在 v1.2 基础上：
- 17 个 A/B 级点位实用信息卡（每个含开放时间、闭馆日、门票、停车、拍照限制、建议停留、地图搜索词、高德/百度地图搜索链接）
- 7 个高风险点位提示（佛光寺、南禅寺、小西天、玉皇庙、青莲寺、崇庆寺、法兴寺）
- 出发前必须核验面板（10 项可勾选，localStorage 保存）
- 11 天主路线每日核对事项
- 资料来源 v1.3 增强（官方信息来源、地图信息说明、核验日期说明）
- 首页状态：路线校准中 → 实用信息核验中（进度 45% → 60%）

v1.2.0 · Shanxi Route Calibration（2026-07-04）
...
| 路线 | 状态 | 进度 | 链接 |
|------|------|------|------|
| 山西古建自驾线 | 实用信息核验中（v1.3） | 60% | [查看规划](https://conanxin.github.io/culture-roadtrip-atlas/trips/shanxi-ancient-architecture-roadtrip/) |
